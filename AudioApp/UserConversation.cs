...
public class UserConversation
{
    ...
    public ApplicationUser Sender { get; set; } // Author's username for display purposes
    public ApplicationUser User2Name { get; set; } // Second Author's username for display purposes

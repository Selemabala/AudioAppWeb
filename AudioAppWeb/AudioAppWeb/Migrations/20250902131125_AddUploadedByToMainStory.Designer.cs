...
namespace AudioAppWeb.Migrations
{
    ...
    [Migration("20250902131125_AddUploadedByToMainStory")]
    partial class AddUploadedByToMainStory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AudioApp.Episode", b =>
                {
                    ...
                    b.HasOne("AudioApp.MainStory", "MainStory")
                        .WithMany("Episodes")
                    ...
                    b.Navigation("MainStory");
                });

            modelBuilder.Entity("AudioApp.MainStory", b =>
                {
                    b.HasOne("AudioApp.UserData.ApplicationUser", "UploadedBy")
